...
This hands-on tutorial is focused on the analysis of Illumina [microarray ](https://www.nature.com/scitable/definition/microarray-202) data using R and Bioconductor, for this tutorial we will use the skills you have developed so far using R, to perform a complete back-to-back data analysis, from raw data to the detection of DEGs and the vizualization of results.

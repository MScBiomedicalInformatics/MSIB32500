...
## Class 10: RNAseq Data Analysis and Clinical Applications, Part III

**Center for Research Informatics, University of Chicago**

October - December 2018; Saturdays 9:00AM - 12:00PM
...
path <- 'C:/Users/rbaoc/Desktop/my_classes/Bioinfo_teaching/fall2018/MSIB32500/lectures'
setwd(path)
...
##-- make forest plot to visualize cox PH model
##-- categorical variables: 2 levels only!
##-- merge C2 an C3 into one level: C2and3
clrmerged <- clinical.sub$cluster
clrmerged[which(clinical.sub$cluster%in%c('2','3'))]  <- '2and3'
table(clrmerged)

age <- clinical.sub$age.at.diagnosis.year

print(paste0('(c) Reduced multivariate cox model for survival with merged clusters'))
m4 <- coxph(surv~(clrmerged + age))
tidy(m4)

p2 <- ggforest(m4, data = clinical.sub, fontsize = 1.2)
print(p2)
